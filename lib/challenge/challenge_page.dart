...
class _ChallengePageState extends State<ChallengePage> {
  ...
  void initState() {
    pageController.addListener(() {
      this.challengeController.currentPage = pageController.page!.toInt() + 1;
    });
    super.initState();
  }
  ...
  void onSelected(bool value){
    if(value){
      challengeController.qtdAnwserRight++;
    }
    nextPage();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        //onPageChanged: (p) {challengeController.currentPage = p+1;},
                            ...
                            child: NextButtonWidget.darkGreen(
                                ...
                                onTap: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ResultPage(title: widget.title, length: widget.questions.length, result: challengeController.qtdAnwserRight,),
                                    ),
                                  );
                                }),
                          )
